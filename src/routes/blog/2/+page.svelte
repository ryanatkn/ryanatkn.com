...
<BlogPost {post}>
	...
	<section class="prose">
		...
		<p>
			I used ChatGPT (<a href="https://openai.com/">openai.com</a>) not to use its text output, but
			as a thinking aid for developing the model beyond control and access. I found it useful for
