...
<div class="prose width_md">
	...
	<p>
		Simply, a virtual social space is a software-mediated context of multiplayer interaction. We're
		all familiar with them - they include our messaging apps, social media feeds, forums, and so on.
	...
	<p>
		...
		complicated when they're combined. To help us along, we'll analyze virtual social spaces through
		the lens of a concrete hypothetical usecase. Let's say I have a public web forum containing a
		specific space that has some very strict rules: participants are allowed to post only on
		Saturday, and posts must contain pictures of cats they know personally. We'll use this example
		to think concretely about the model.
	</p>
	<h2>The model</h2>
	<p>
	...
	<p>
		...
		forum, have carved a distinct boundary of control out of the infinite virtual void. The software
	...
	<p>
		...
		boundaries. In our hypothetical, we explicitly support distribution in a few open-ended ways, so
		the joy of each post can spread wherever it's wanted:
	</p>
	<ul>
	...
	<p>
		...
		exercise our control over the space to change the rules of interaction, so every dog can have
		its day too.
	</p>
	...
	<p>
		...
		Imagining Social Platforms" (<a href="https://consentful.systems">consentful.systems</a>) by
		Jane Im (<a href="https://imjane.net/">imjane.net</a>) and colleagues.
	</p>
	<p>
		I used ChatGPT (<a href="https://openai.com/">openai.com</a>) not to use its text output, but as
		a thinking aid for developing the model beyond control and access. I found it useful for
