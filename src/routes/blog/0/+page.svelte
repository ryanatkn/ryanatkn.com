...
<ul>
	...
	<li>
		a <a href="https://github.com/pngwn/MDsveX">composable text language</a> with a rich vocabulary that
		can be used to write chat messages, forum and blog posts, todo items, and so on, and also construct
...
<p>
	<strong>felt.social business model</strong>: no ads, no crypto, free and fully open source (not
	"open core", <a href="https://wikipedia.org/wiki/MIT_License">permissively licensed</a>); users
	pay for service and if it's sustainable we'll creatively subsidize users for more equitable access
</p>
<p>
