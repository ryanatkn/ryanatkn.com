...
<p>
	...
	open source, if that's your thing, but please no solicitations): if you read this document and
	have something in mind, I would enjoy hearing about it, and if it's something in the open source,
	go do, don't ask for permission! Some of my public collaborations include:
</p>
<ul>
...
<ul>
	<li>
		...
		communication, and social environments? What else do we need to realize more of its liberatory
		potential?
	</li>
	<li>
